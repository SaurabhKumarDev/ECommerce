...
export default function Product() {
    ...
    const pageNumber = searchParams.get("pageNumber") || 2;
                                            ...
                                            <>
                                                <h3 className=" -my-3 flow-root">
                                                    <DisclosureButton className="group flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500">
                                                        ...
                                                        <FormLabel sx={{ color: "black" }} id="demo-radio-buttons-group-label" className='text-gray-900 font-medium text-sm'>{section.name}</FormLabel>
                                                        <span className="ml-6 flex items-center">
                                                            <PlusIcon aria-hidden="true" className="size-5 group-data-[open]:hidden" />
                                                            <MinusIcon aria-hidden="true" className="size-5 [.group:not([data-open])_&]:hidden" />
                                                        </span>
